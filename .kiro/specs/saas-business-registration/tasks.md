...
- [x] 2.1 Building_groups 테이블 생성
  - 조직별 건물 그룹 관리 (organization_id 기반)
...
- [ ] 8.1 멀티테넌시 환경 최적화 인덱스 생성
  - organization_id 기반 복합 인덱스
  - RLS 성능 최적화 인덱스
  - 자주 사용되는 쿼리 패턴 최적화
  - _요구사항: 성능 요구사항_
...
- [ ] 9.1 멀티테넌시 데이터 격리 테스트
  - 조직 간 데이터 접근 차단 검증
  - RLS 정책 동작 확인
  - 권한 기반 접근 제어 테스트
  - _요구사항: 6.1, 6.2, 6.3_

- [ ] 9.2 사업자 회원가입 플로우 통합 테스트
  - 전체 가입 프로세스 검증
  - 인증 시스템 동작 확인
  - 오류 상황 처리 테스트
