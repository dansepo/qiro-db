-- =====================================================
-- 민원 및 회계 관리 시스템 - 공지사항 및 서비스 관리 테이블 (기존 구조 호환)
-- 작성일: 2025-01-30
...
CREATE TABLE IF NOT EXISTS bms.announcement_attachments (
    ...
    uploaded_by UUID NOT NULL REFERENCES bms.users(user_id),
...
CREATE TABLE IF NOT EXISTS bms.announcement_views (
    ...
    viewer_id UUID REFERENCES bms.users(user_id),
    viewer_ip INET,
    user_agent TEXT,
...
CREATE TABLE IF NOT EXISTS bms.service_bookings (
    ...
    -- 예약자 정보
    booker_id UUID REFERENCES bms.users(user_id),
    ...
    confirmed_by UUID REFERENCES bms.users(user_id),
    ...
    cancelled_by UUID REFERENCES bms.users(user_id),
...
CREATE TABLE IF NOT EXISTS bms.service_feedback (
    ...
    submitted_by UUID REFERENCES bms.users(user_id)
);
...
CREATE OR REPLACE FUNCTION bms.insert_default_announcement_categories(p_company_id UUID)
RETURNS VOID AS $$
BEGIN
...
-- 기본 서비스 데이터 삽입 함수
CREATE OR REPLACE FUNCTION bms.insert_default_services(p_company_id UUID, p_building_id UUID)
RETURNS VOID AS $$
DECLARE
    default_user_id UUID;
BEGIN
    -- 기본 사용자 ID 조회 (첫 번째 사용자)
    ...
    IF default_user_id IS NOT NULL THEN
        ...
        (p_company_id, p_building_id, 'CLEANING', '청소 서비스', '생활 서비스', '세대 내 청소 서비스', 'PAID', 50000, 120, 1, '{"monday": {"start": "09:00", "end": "18:00"}, "tuesday": {"start": "09:00", "end": "18:00"}, "wednesday": {"start": "09:00", "end": "18:00"}, "thursday": {"start": "09:00", "end": "18:00"}, "friday": {"start": "09:00", "end": "18:00"}}'::jsonb, default_user_id),
        (p_company_id, p_building_id, 'LAUNDRY', '세탁 서비스', '생활 서비스', '의류 세탁 및 드라이클리닝', 'PAID', 15000, 60, 10, '{"monday": {"start": "08:00", "end": "20:00"}, "tuesday": {"start": "08:00", "end": "20:00"}, "wednesday": {"start": "08:00", "end": "20:00"}, "thursday": {"start": "08:00", "end": "20:00"}, "friday": {"start": "08:00", "end": "20:00"}, "saturday": {"start": "09:00", "end": "17:00"}}'::jsonb, default_user_id),
        (p_company_id, p_building_id, 'DELIVERY', '택배 보관', '편의 서비스', '택배 수령 및 보관 서비스', 'FREE', 0, 30, 50, '{"monday": {"start": "00:00", "end": "23:59"}, "tuesday": {"start": "00:00", "end": "23:59"}, "wednesday": {"start": "00:00", "end": "23:59"}, "thursday": {"start": "00:00", "end": "23:59"}, "friday": {"start": "00:00", "end": "23:59"}, "saturday": {"start": "00:00", "end": "23:59"}, "sunday": {"start": "00:00", "end": "23:59"}}'::jsonb, default_user_id),
        (p_company_id, p_building_id, 'MEETING_ROOM', '회의실 대여', '시설 서비스', '공용 회의실 대여 서비스', 'PAID', 20000, 60, 8, '{"monday": {"start": "09:00", "end": "22:00"}, "tuesday": {"start": "09:00", "end": "22:00"}, "wednesday": {"start": "09:00", "end": "22:00"}, "thursday": {"start": "09:00", "end": "22:00"}, "friday": {"start": "09:00", "end": "22:00"}, "saturday": {"start": "10:00", "end": "18:00"}, "sunday": {"start": "10:00", "end": "18:00"}}'::jsonb, default_user_id)
